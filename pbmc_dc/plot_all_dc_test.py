...
davae_path = 'dann_vae/benchmark1/dc_davae_save.h5ad'
...
ax.scatter(data_davae_emb[:, 0], data_davae_emb[:, 1], c=davae_batches, cmap=batch_cmap, s=size,
           linewidth=0)
ax.spines['top'].set_visible(False)
ax.spines['right'].set_visible(False)
...
ax.scatter(data_davae_emb[:, 0], data_davae_emb[:, 1], c=davae_label, cmap=c_map, s=size,
           linewidth=0)
ax.spines['top'].set_visible(False)
ax.spines['right'].set_visible(False)
# plt.xlabel(xy_label + '1', size=xy_label_size)
...
ax.scatter(data_scan_emb[:, 0], data_scan_emb[:, 1], c=davae_batches, cmap=batch_cmap, s=size,
           linewidth=0)
ax.spines['top'].set_visible(False)
ax.spines['right'].set_visible(False)
# plt.xlabel(xy_label + '1', size=xy_label_size)
...
ax.scatter(data_scan_emb[:, 0], data_scan_emb[:, 1], c=davae_label, cmap=c_map, s=size,
           linewidth=0)
ax.spines['top'].set_visible(False)
ax.spines['right'].set_visible(False)
# plt.xlabel(xy_label + '1', size=xy_label_size)
...
ax.scatter(data_desc_emb[:, 0], data_desc_emb[:, 1], c=davae_batches, cmap=batch_cmap, s=size,
           linewidth=0)
ax.spines['top'].set_visible(False)
ax.spines['right'].set_visible(False)
# plt.xlabel(xy_label + '1', size=xy_label_size)
...
ax.scatter(data_desc_emb[:, 0], data_desc_emb[:, 1], c=davae_label, cmap=c_map, s=size,
           linewidth=0)
ax.spines['top'].set_visible(False)
ax.spines['right'].set_visible(False)
# plt.xlabel(xy_label + '1', size=xy_label_size)
...
ax.scatter(data_seurat_emb[:, 0], data_seurat_emb[:, 1], c=davae_batches, cmap=batch_cmap, s=size,
           linewidth=0)
ax.spines['top'].set_visible(False)
ax.spines['right'].set_visible(False)
# plt.xlabel(xy_label + '1', size=xy_label_size)
...
ax.scatter(data_seurat_emb[:, 0], data_seurat_emb[:, 1], c=davae_label, cmap=c_map, s=size,
           linewidth=0)
ax.spines['top'].set_visible(False)
ax.spines['right'].set_visible(False)
# plt.xlabel(xy_label + '1', size=xy_label_size)
...
ax.scatter(data_scgen_emb[:, 0], data_scgen_emb[:, 1], c=davae_batches, cmap=batch_cmap, s=size,
           linewidth=0)
ax.spines['top'].set_visible(False)
ax.spines['right'].set_visible(False)
# plt.xlabel(xy_label + '1', size=xy_label_size)
...
ax = fig.add_subplot(2, 6, 12)
ax.scatter(data_scgen_emb[:, 0], data_scgen_emb[:, 1], c=davae_label, cmap=c_map, s=size,
           linewidth=0)
ax.spines['top'].set_visible(False)
ax.spines['right'].set_visible(False)
# plt.xlabel(xy_label + '1', size=xy_label_size)
