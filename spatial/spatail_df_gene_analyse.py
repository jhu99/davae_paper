...
davae_path = '/Users/zhongyuanke/data/dann_vae/spatial/anterior_label_01.h5ad'
adata_davae = sc.read_h5ad(davae_path)
label = adata_davae.obs['celltype']
label = list(label)
from collections import Counter
print(Counter(label))
label = ['nan' if i == 'Endo' or i == 'L6b' or i == 'CR' else i for i in label]
...
# sc.pl.rank_genes_groups_heatmap(adata_davae,
...
geneset=['Nrgn','Cck','Sst','Pvalb','Pcp4','Penk','Plp1','Mbp','Pcbp3','Gng4']
